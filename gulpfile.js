...
gulp.task('update-licenses', function() {
    ...
    return Promise.all([
        run_completion(run('command -v composer >/dev/null 2>&1 && composer licenses --format=json --no-dev > public/license/composer.LICENSES || echo "[]" > public/license/composer.LICENSES').exec()),
