...
return [
    ...
    'kit'                                => 'Kit',
    'bulk_import_barcode'                => 'Import by Barcode',
    'bulk_import_barcode_codes'          => 'Barcodes',
    'bulk_import_barcode_help'           => 'Paste a list of barcodes, one per line. Each one that is found creates a blocked item (hidden from Sales) with name, brand and photo preloaded, with no price or stock. To activate it, edit it and give it a price and stock - it unblocks itself.',
    'bulk_import_barcode_required'       => 'Paste at least one barcode.',
    'bulk_import_barcode_submit'         => 'Import',
    'bulk_import_barcode_summary'        => '%d item(s) preloaded. %d code(s) not found. %d code(s) skipped (already existed or were invalid).',
    'location'                           => 'Location',
    'lookup_barcode'                     => 'Look up barcode',
    'lookup_barcode_error'               => 'Could not look up that code, try again.',
    'lookup_barcode_found'               => 'Found — check the details before saving.',
    'lookup_barcode_not_found'           => 'That code was not found. You can enter the item by hand.',
    'lookup_barcode_searching'           => 'Searching…',
