...
return [
    ...
    'bulk_import_barcode'                => 'Importar por Código',
    'bulk_import_barcode_codes'          => 'Códigos de Barras',
    'bulk_import_barcode_help'           => 'Pegá una lista de códigos de barras, uno por línea. Por cada uno que se encuentre, se crea un artículo bloqueado (oculto en Ventas) con nombre, marca y foto precargados, sin precio ni stock. Para activarlo, editalo y cargale un precio y stock — se desbloquea solo.',
    'bulk_import_barcode_required'       => 'Pegá al menos un código de barras.',
    'bulk_import_barcode_submit'         => 'Importar',
    'bulk_import_barcode_summary'        => '%d artículo(s) precargado(s). %d código(s) no encontrado(s). %d código(s) omitido(s) (ya existían o eran inválidos).',
    'location'                           => 'Ubicación',
    'lookup_barcode'                     => 'Buscar por código',
    'lookup_barcode_error'               => 'No se pudo consultar el código, probá de nuevo.',
    'lookup_barcode_found'               => 'Encontrado — revisá los datos antes de guardar.',
    'lookup_barcode_not_found'           => 'No se encontró ese código. Podés cargar el artículo a mano.',
    'lookup_barcode_searching'           => 'Buscando…',
